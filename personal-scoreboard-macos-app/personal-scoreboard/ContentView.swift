...
struct ContentView: View {
    ...
    var body: some View {
        ...
        let nba_event = Event(away_team: clippers, home_team: lakers, sport_type: SportType.nba, away_score: "94", home_score: "100", status_string: "Q4 | 24.5", yardage_string: "Not relevant")
